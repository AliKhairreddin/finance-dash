        ...
        {mode === "match" ? (
          ...
          <>
            ...
            <section className="form-section">
              ...
              <div className="form-grid"><label>Category<NativeSelect value={category} onValueChange={setCategory}>{categories.map((item) => <NativeSelectOption key={item} value={item}>{item}</NativeSelectOption>)}</NativeSelect></label><label>Team<NativeSelect value={teamId} onValueChange={setTeamId}><NativeSelectOption value="">No team</NativeSelectOption>{dashboard.teams.map((team) => <NativeSelectOption key={team.id} value={team.id}>{team.name}</NativeSelectOption>)}</NativeSelect></label></div>
            </section>
