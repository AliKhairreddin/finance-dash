  ...
  return (
    <div className="holdings-stack">
      ...
      <section className="panel">
        ...
        <div className="income-callout"><CircleAlert size={17} /><span>USD totals are approximate Yahoo market conversions. Native balances remain the source of truth and payment/accounting decisions should use them.</span></div>
