...
// Generated by Wrangler by running `wrangler types --env-file=.env.example --include-runtime=false --strict-vars=false` (hash: 96e29d1667aeed3647bab0dcb90efa4b)
interface __BaseEnv_Env {
	...
	YAHOO_FINANCE_CHART_URL: string;
}
