/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --include-runtime=false --strict-vars=false` (hash: 69fb41a718b4918a6d00fcdb33daf0b9)
export {};
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_APP_URL" | "PORT" | "VITE_API_BASE" | "VITE_CONVEX_URL" | "CONVEX_URL" | "CONVEX_DEPLOYMENT" | "CONVEX_SERVICE_TOKEN" | "MANAGEMENT_REPORT_IMPORT_TOKEN" | "AUTH_USERNAME" | "AUTH_PASSWORD_HASH" | "AUTH_SESSION_SECRET" | "OPENROUTER_API_KEY" | "WISE_API_TOKEN" | "WISE_PROFILE_IDS" | "WISE_ENVIRONMENT" | "REVOLUT_ENVIRONMENT" | "REVOLUT_CLIENT_ID" | "REVOLUT_ISSUER" | "REVOLUT_PRIVATE_KEY_PEM" | "REVOLUT_REFRESH_TOKEN" | "SLASH_API_KEY" | "SLASH_LEGAL_ENTITY_ID" | "SLASH_BASE_URL" | "AMEX_TOKEN_URL" | "AMEX_API_BASE_URL" | "AMEX_CLIENT_ID" | "AMEX_CLIENT_SECRET" | "AMEX_REFRESH_TOKEN" | "AMEX_ACCOUNT_IDS" | "AMEX_ACCOUNT_PATH_TEMPLATE" | "AMEX_TRANSACTIONS_PATH_TEMPLATE" | "MERIT_API_BASE_URL" | "MERIT_GET_INVOICES_PATH" | "MERIT_CREATE_INVOICE_PATH" | "MERIT_DELIVER_INVOICE_PATH" | "MERIT_API_ID" | "MERIT_API_KEY" | "MERIT_WRITES_ENABLED" | "MERIT_DEFAULT_ITEM_CODE" | "MERIT_DEFAULT_COUNTRY_CODE" | "REVENUE_TIMEZONE" | "KISSTERRA_TUNE_NETWORK_ID" | "KISSTERRA_TUNE_API_KEY" | "KISSTERRA_TUNE_API_BASE_URL" | "COINBASE_SPOT_PRICES_URL">> {}
}
